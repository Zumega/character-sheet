<?php
  $arySkills = array(
    '================='=>array(),
    'Animal Handaling'=>array('Animal Training', 'Riding', 'Veterinary', 'Zoology'),
    'Medical Expertise'=>array('dentistry', 'forensics', 'general practice', 'genetics', 'internal medicine', 'neurology', 'pharmaceuticals', 'physiology', 'psychiatry', 'rehabilitation', 'surgery', 'toxicology', 'veterinary medicine'),
    ...
    'Planetary Vehicles'=>array('aquatic navigation', 'cars', 'canoes', 'equestrian', 'ground vehicle repair', 'horse-drawn conveyances', 'hovercraft', 'industrial vehicles', 'land navigation', 'large ground transports', 'military combat vehicles', 'powerboats', 'sailing', 'scooters', 'scuba diving', 'skiffs', 'submarines', 'yachts'),
    'Guns'=>array('assault rifles', 'energy weapons', 'grenade launchers', 'gunsmithing', 'machine guns', 'pistols', 'rifles', 'shotguns'),
    'Ranged Weapons'=>array('Blowguns', 'bows', 'crossbows', 'darts', 'grenade', 'javelin', 'ranged weaponsmithing', 'slings', 'throwing axes', 'throwing knives'),
    'Heavy Weapons'=>array('artillery', 'catapults', 'demolitions', 'forward observer', 'mounted guns', 'repair heavy weapons', 'rocket launchers', 'ship\'s cannons', 'siege weapons'),
    'Scientific Expertise'=>array('earth sciences', 'historical sciences', 'life sciences', 'mathematical sciences'),
    ...
    'Technical Eng.*'=>array('Communication systems', 'computer programming', 'hacking', 'create/alter technical devices', 'demolitions', 'electronics', 'technical repair', 'technical security systems'),
    'Mechanical Eng.*'=>array('create mechanical devices', 'machinery maintenance', 'mechanical repairs', 'fix mechanical security systems', 'plumbing'),
    'Unarmed Combat'=>array('boxing', 'brawling', 'judo', 'karate', 'kung fu', 'savate', 'wrestling'),
    ...
    'Melee Weapons'=>array('clubs', 'knives', 'melee weaponsmithing', 'nunchaku', 'pole arms', 'swords', 'whips')
  );
  ksort($arySkills);
?>
